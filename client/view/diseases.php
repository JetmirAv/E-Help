		...
		<div class="row">
			...
			<div class="col-md-7 py-5">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item diabeti-image-1 active">
				    </div>
				    <div class="carousel-item diabeti-image-2">
				    </div>
				  </div>
		...
		<div class="row">
			...
			<div class="col-md-7 py-5">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item hepatiti-image-1 active">
				    </div>
				    <div class="carousel-item hepatiti-image-2">
				    </div>
				  </div>
				  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
				    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
		...
		<div class="row">
			...
			<div class="col-md-7 py-5">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item hipertensioni-image-1 active">
				    </div>
				    <div class="carousel-item hipertensioni-image-2">
				    </div>
				  </div>
				  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
				    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
		...
		<div class="row">
			...
			<div class="col-md-7 py-5">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item lupus-image-1 active">
				    </div>
				    <div class="carousel-item lupus-image-2">
				    </div>
				  </div>
				  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
				    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
