...
<body>
    ...
    <script>
        ...
        function seeReceipts(id) {
            ...
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/patient/see_receipts',
                type: 'POST',
        ...
        $("#add_disease_to_patient").on('click', e => {
            ...
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/doctor/get_diseases',
                type: 'GET',
                beforeSend: function(request) {
                    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    request.setRequestHeader("Accept", "application/json");
        ...
        $("#add_doctors_to_patient").on('click', e => {
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/patient/get_patient_doctors',
                type: 'GET',
                beforeSend: function(request) {
                    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    request.setRequestHeader("Accept", "application/json");
        ...
        $("#save-disease-for-patient").on('click', e => {
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/doctor/add_disease_to_patient',
                type: 'POST',
                beforeSend: function(request) {
                    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    request.setRequestHeader("Accept", "application/json");
        ...
        $("#save-doctor-for-patient").on('click', e => {
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/patient/add_doctor_to_patient',
                type: 'POST',
                beforeSend: function(request) {
                    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    request.setRequestHeader("Accept", "application/json");
        ...
        $("#add-receipt").on('click', e => {
            e.preventDefault()
            $.ajax({
                url: 'http://www.api.dk-health.tk/' + 'api/doctor/add_receipt',
                type: 'POST',
                beforeSend: function(request) {
                    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    request.setRequestHeader("Accept", "application/json");
        ...
        $('#update_profile').submit(function(e) {
            ...
            request.open('post', 'http://http://www.api.dk-health.tk/api/auth/update')
            request.setRequestHeader('Authorization', "<?= "Bearer " . $_SESSION['token']; ?>")
